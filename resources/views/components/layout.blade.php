...
<body class="h-full">
    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="shrink-0">
                <img src="https://picsum.photos/200/300" alt="Your Company" class="size-8" />
            </div>
        ...
        <div class="border-t border-white/10 pt-4 pb-3">
            ...
            <div class="shrink-0">
                <img src="https://picsum.photos/200/300" alt="" class="size-10 rounded-full outline -outline-offset-1 outline-white/10" />
            </div>
            <div class="ml-3">
                <div class="text-base/5 font-medium text-white">Laaaaaaaryyyy</div>
                <div class="text-sm font-medium text-gray-400">Laaaaaaaryyyy@example.com</div>
            </div>
